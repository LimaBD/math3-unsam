...
"""
Some proof of concept for a validation decorator
that uses pydantic models to validate dictionaries.
"""
    ...
    def decorator(func):
        ...
        def inner(*func_args, **func_kwargs):
            ...
            for key, decorator_model in decorator_kwargs.items():
                ...
                func_passed_value = func_args[key_index] if key_index < len(func_args) else func_kwargs.get(key)
